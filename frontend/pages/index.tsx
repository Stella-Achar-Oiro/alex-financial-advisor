...
import { Compass, BarChart2, TrendingUp, Clock, Zap, ShieldCheck, FileText } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 rounded-xl hover:shadow-lg transition-shadow">
              <div className="flex justify-center mb-4 text-ai-accent"><Compass size={40} /></div>
            ...
            <div className="text-center p-6 rounded-xl hover:shadow-lg transition-shadow">
              <div className="flex justify-center mb-4 text-primary"><BarChart2 size={40} /></div>
            ...
            <div className="text-center p-6 rounded-xl hover:shadow-lg transition-shadow">
              <div className="flex justify-center mb-4 text-green-600"><TrendingUp size={40} /></div>
            ...
            <div className="text-center p-6 rounded-xl hover:shadow-lg transition-shadow">
              <div className="flex justify-center mb-4 text-accent"><Clock size={40} /></div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-md">
              <div className="text-accent mb-4"><Zap size={28} /></div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md">
              <div className="text-accent mb-4"><FileText size={28} /></div>
