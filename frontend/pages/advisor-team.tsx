...
import { Compass, BarChart2, TrendingUp, Clock, type LucideIcon } from 'lucide-react';
            ...
            {agents.map((agent) => (
              ...
              >
                ...
                <div className="relative">
                  <div className={`mb-4 ${agent.color} ${isAgentActive(agent.name) ? 'animate-strong-pulse' : ''}`}>
                    <agent.icon size={40} />
                  </div>
